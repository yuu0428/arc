(() => {
  ...
  function initializeFallSim() {
    if (!ENABLE_FALL_SIM) return;

    const person = document.querySelector('.walking-person');
    const circle = document.querySelector('.logo-placement');
    const floorEl = document.querySelector('.logo-overlay');
  ...
  window.initializeFallSim = initializeFallSim;
})();
